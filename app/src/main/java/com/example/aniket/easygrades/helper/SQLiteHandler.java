...
/**
 *  The SQLite handler maintains a local database of user login
 *  and their details.
 */
...
//    private static final String KEY_UID = "uid";
     ...
     * */
    public void addUser(String dbid, String username, String email, String created_at) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(KEY_DBID, dbid); // Email
        values.put(KEY_USERNAME, username); // Name
        values.put(KEY_DOB, ""); // Email
